...
class SyncapTextField(RawField):
    vocab_cls = Vocab
    # Dictionary mapping PyTorch tensor dtypes to the appropriate Python
    # numeric type.
    dtypes = {
    ...
    def __init__(self, use_vocab=True, init_token=None, eos_token=None, fix_length=None, dtype=torch.long,
        ...
        super(SyncapTextField, self).__init__(preprocessing, postprocessing)
    ...
    def build_vocab(self, vocab_name, **kwargs):
        w2ix = json.load(open(vocab_name))
        sources = [w for w in w2ix.keys()]
