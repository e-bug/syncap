...
DATA_SPLIT="coco_heldout_1_chunk_seq"
...
CKPT="/science/image/nlp-datasets/emanuele/checkpoints/syncap/syncap/${DATA_SPLIT}/${MODEL_NAME}${MODEL_SUFF}/checkpoint.best.pth.tar"
